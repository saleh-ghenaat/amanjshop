        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="<?php echo e(route('admin.notify.sms.index')); ?>" class="btn btn-info btn-sm">بازگشت</a>
                </section>

                <section>
                    <form action="<?php echo e(route('admin.notify.sms.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" class="form-control form-control-sm"
                                        rows="6"><?php echo e(old('body')); ?></textarea>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/notify/sms/create.blade.php ENDPATH**/ ?>