                    ...
                    <tbody>
                        ...
                        <tr class="table-primary">
                           ...
                           <tr class="border-bottom">
                            <th>نوع پرداخت</th>
                            <td class="text-left font-weight-bolder">
                             <?php if($order->payment_type == 0): ?> آنلاین  <?php elseif($order->payment_type == 1): ?> آفلاین <?php else: ?> در محل <?php endif; ?>
                            </td>
                        </tr>
                           <tr class="border-bottom">
                            <th>وضعیت پرداخت</th>
                            <td class="text-left font-weight-bolder">
                                <?php if($order->payment_status == 0): ?> پرداخت نشده  <?php elseif($order->payment_status == 1): ?> پرداخت شده <?php elseif($order->payment_status == 2): ?> باطل شده <?php else: ?> برگشت داده شده <?php endif; ?>
                            </td>
                        </tr>
                           <tr class="border-bottom">
                            <th>مبلغ ارسال</th>
                           ...
                           <tr class="border-bottom">
                            <th>وضعیت ارسال</th>
                            <td class="text-left font-weight-bolder">
                                <?php if($order->delivery_status == 0): ?> ارسال نشده  <?php elseif($order->delivery_status == 1): ?> درحال ارسال <?php elseif($order->delivery_status == 2): ?>  ارسال شده <?php else: ?> تحویل شده <?php endif; ?>
                            </td>
                        </tr>
                           <tr class="border-bottom">
                            <th>تاریخ ارسال</th>
                          ...
                          <tr class="border-bottom">
                            <th>وضعیت سفارش</th>
                            <td class="text-left font-weight-bolder">
                                <?php if($order->order_status == 1): ?> در انتظار تایید  <?php elseif($order->order_status == 2): ?>  تایید نشده <?php elseif($order->order_status == 3): ?> تایید شده <?php elseif($order->order_status == 4): ?> باطل شده <?php elseif($order->order_status == 5): ?> مرجوع شده <?php else: ?> بررسی نشده <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hassankhosrojerdi/Desktop/project/resources/views/admin/market/order/show.blade.php ENDPATH**/ ?>