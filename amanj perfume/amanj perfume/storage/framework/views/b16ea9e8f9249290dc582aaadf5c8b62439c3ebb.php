    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="<?php echo e(route('admin.market.discount.amazingSale')); ?>" class="btn btn-info btn-sm">بازگشت</a>
            </section>

            <section>
                <form action="<?php echo e(route('admin.market.discount.amazingSale.update', $amazingSale->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="product_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="<?php echo e($product->id); ?>" <?php if(old('product_id', $amazingSale->product_id) == $product->id): ?> selected <?php endif; ?>><?php echo e($product->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="percentage" value="<?php echo e(old('percentage', $amazingSale->percentage)); ?>">
                            </div>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" <?php if(old('status', $amazingSale->status) == 0): ?> selected <?php endif; ?>>غیرفعال</option>
                                    <option value="1" <?php if(old('status', $amazingSale->status) == 1): ?> selected <?php endif; ?>>فعال</option>
                                </select>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/market/discount/amazing-edit.blade.php ENDPATH**/ ?>