                    ...
                    <section id="header-notification" class="header-notifictation rounded">
                        ...
                        <ul class="list-group rounded px-0">
                            <li class="list-group-item list-group-item-action">
                                <section class="media">
                                    <img class="notification-img" src="<?php echo e(asset('admin-assets/images/avatar-2.jpg')); ?>" alt="avatar">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <section class="media">
                                    <img class="notification-img" src="<?php echo e(asset('admin-assets/images/avatar-2.jpg')); ?>" alt="">
                                    <section class="media-body pr-1">
                                        <h5 class="notification-user">محمد هاشمی</h5>
                                        <p class="notification-text">این یک متن تستی است</p>
                                        <p class="notification-time">30 دقیقه پیش</p>
...
<?php /**PATH /Users/hassankhosrojerdi/Desktop/project/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>