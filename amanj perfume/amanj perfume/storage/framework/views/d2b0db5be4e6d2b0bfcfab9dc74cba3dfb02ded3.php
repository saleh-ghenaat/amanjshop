                    ...
                    <section class="mt-3 mt-md-auto text-end">
                        <section class="d-inline px-md-3">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route('auth.customer.login-register-form')); ?>" class="btn btn-link text-decoration-none text-dark profile-button">
                        ...
                        <section class="header-cart d-inline ps-3 border-start position-relative">
                            ...
                            <section class="header-cart-dropdown">
                                <section class="border-bottom d-flex justify-content-between p-2">
                                    ...
                                    <a class="text-decoration-none text-info" href="<?php echo e(route('customer.sales-process.cart')); ?>">مشاهده سبد خرید </a>
                                </section>
                                ...
                                ?>
                                    ...
                                    <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                        <img class="flex-shrink-1" src="<?php echo e(asset($cartItem->product->image['indexArray']['medium'])); ?>" alt="">
                                        <section class="w-100 text-truncate"><a class="text-decoration-none text-dark" href="<?php echo e(route('customer.market.product', $cartItem->product)); ?>"><?php echo e($cartItem->product->name); ?></a></section>
                                        <section class="flex-shrink-1"><a class="text-muted text-decoration-none p-1" href="<?php echo e(route('customer.sales-process.remove-from-cart', $cartItem)); ?>"><i class="fa fa-trash-alt"></i></a></section>
                                    </section>
                                ...
                                <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                    <section class=""><section>مبلغ قابل پرداخت</section><section> <?php echo e(priceFormat($totalProductPrice - $totalDiscount)); ?>تومان</section></section>
...
<?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/customer/layouts/header.blade.php ENDPATH**/ ?>