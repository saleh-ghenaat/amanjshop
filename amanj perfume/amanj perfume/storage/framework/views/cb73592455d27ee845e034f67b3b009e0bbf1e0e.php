  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="<?php echo e(route('admin.market.discount.amazingSale.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                     <section class="row">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/market/discount/amazing-create.blade.php ENDPATH**/ ?>