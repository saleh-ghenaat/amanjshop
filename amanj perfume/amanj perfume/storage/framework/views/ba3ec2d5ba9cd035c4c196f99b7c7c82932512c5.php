...
unset($__errorArgs, $__bag); ?>
        ...
        <section id="resend-otp" class="d-none">
            <a href="<?php echo e(route('auth.customer.login-resend-otp', $token)); ?>" class="text-decoration-none text-primary">دریافت مجدد کد تایید</a>
        </section>
...
<?php echo $__env->make('customer.layouts.master-simple', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/desk/project-toplearn/resources/views/customer/auth/login-confirm.blade.php ENDPATH**/ ?>