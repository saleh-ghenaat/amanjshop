                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="<?php echo e($menu->id); ?>"  <?php if(old('parent_id') == $menu->id): ?> selected <?php endif; ?>><?php echo e($menu->name); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/desk/project۰org/resources/views/admin/content/menu/create.blade.php ENDPATH**/ ?>