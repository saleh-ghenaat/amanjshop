  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="<?php echo e(route('admin.content.banner.store')); ?>" method="POST" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
                    <section class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="position" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php if(old('position') == $key): ?> selected <?php endif; ?>><?php echo e($value); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/content/banner/create.blade.php ENDPATH**/ ?>