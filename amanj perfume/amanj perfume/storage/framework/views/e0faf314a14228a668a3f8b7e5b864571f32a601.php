                            ...
                            <div class="content-box">
                                <div class="container-fluid">
                                    <form class="row" method="post"
                                        action="<?php echo e(route('customer.profile.profile.update')); ?>">
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="comment-item" for="floatingInputOstan">
                                                    ...
                                                    <select name="province" id="province" class="form-select">
                                                        ...
                                                        <option value="<?php echo e($province->id); ?>" data-url="<?php echo e(route('customer.sales-process.get-cities', $province->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.layouts.master-one-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\amanj perfume\resources\views/customer/profile/edit-profile.blade.php ENDPATH**/ ?>