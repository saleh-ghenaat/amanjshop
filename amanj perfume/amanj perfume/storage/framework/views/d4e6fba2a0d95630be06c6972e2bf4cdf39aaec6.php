    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="<?php echo e(route('admin.market.property.index')); ?>" class="btn btn-info btn-sm">بازگشت</a>
            </section>

            <section>
                <form action="<?php echo e(route('admin.market.property.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <section class="row">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit" value="<?php echo e(old('unit')); ?>" class="form-control form-control-sm">
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/market/property/create.blade.php ENDPATH**/ ?>