  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="<?php echo e(route('admin.market.discount.commonDiscount.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="percentage" value="<?php echo e(old('percentage')); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                           ...
                           <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="minimal_order_amount" value="<?php echo e(old('minimal_order_amount')); ?>" class="form-control form-control-sm">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="form-control form-control-sm">
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\saleh\Desktop\laravel-project\resources\views/admin/market/discount/common-create.blade.php ENDPATH**/ ?>