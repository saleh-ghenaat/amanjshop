                ...
                <div class="header-btn">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                            <section><a class="dropdown-item" href="<?php echo e(route('customer.profile.profile')); ?>"><i class="fa fa-user-circle"></i>پروفایل کاربری</a></section>
                            ...
                            <section><a class="dropdown-item" href="<?php echo e(route('auth.customer.logout')); ?>"><i class="fa fa-sign-out-alt"></i>خروج</a>
                            </section>
                    ...
                    <div class="header-btn-login d-lg-block d-none">
                        <a href="<?php echo e(route('auth.customer.login-register-form')); ?>" class="btn"><i class="bi bi-person-fill"></i> ورود / ثبت نام</a>
                    </div>
                    <?php endif; ?>
...
<!-- end mega menu --><?php /**PATH C:\Users\saleh\Desktop\amanj perfume\resources\views/customer/layouts/header.blade.php ENDPATH**/ ?>